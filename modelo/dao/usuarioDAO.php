...
class UsuarioDAO {
    ...
    public function registrarUsuario(Usuario $usuario){
        ...
        $stmt1 = "INSERT INTO usuario VALUES (NULL,:nombre,:correo,:password,:telefono,:fechanac,:sexo,:administrador)"; 
    ...
    public function editarUsuario($usuario){
        ...
        $stmt1 = "UPDATE usuario SET nombre = :nombre, correo = :correo, password = :password, telefono = :telefono, fechanac = :fechanac, sexo = :sexo, administrador = :administrador  WHERE codEdst = :idUsuario"; 
